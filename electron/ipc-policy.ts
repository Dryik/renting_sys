...
export const ipcAccessPolicy = {
  ...
  "accounting:save-staff-daily-closing": { requiresWriteAccess: true },
  "accounting:get-weekly-income": { requiresWriteAccess: false },
  "employee-loans:list-employees": { requiresWriteAccess: false },
  "employee-loans:list": { requiresWriteAccess: false },
  "employee-loans:list-payments": { requiresWriteAccess: false },
  "employee-loans:create": { requiresWriteAccess: true },
  "employee-loans:repay": { requiresWriteAccess: true },
  "employee-loans:void": { requiresWriteAccess: true },
  "accessories:list": { requiresWriteAccess: false },
  "accessories:create": { requiresWriteAccess: true },
  "accessories:update": { requiresWriteAccess: true },
  ...
  "settings:select-owner-signature": { requiresWriteAccess: true },
  "settings:clear-owner-signature": { requiresWriteAccess: true },
